 ...
 */
public class MLSTPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType MLST = new AnalysisType("MLST");

	public MLSTPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <id>1449d2ed-03ce-41b8-a746-b5328c5f370a</id>}
		 * </pre>
		 * 
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#f4e916"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new MLSTPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
